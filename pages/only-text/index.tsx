...
const OnlyText = () => {
  const textJa = `ある日、きりもちを焼き忘れてしまい 
翌日まるで玉手箱を開けたかのように 
...
`;
  ...
  const textEn = `One day, I forgot to bake Kirimochi. 
...
`;
  ...
  //   const jaPages = paginateByBinarySearch(profileJa, size.w, size.h);

  return (
    <>
      <FontTester>
        <FullPageText textJa={textJa} textEn={textEn} />
      </FontTester>
    </>
  );
};
